...
const Sidebar = () => {
    ...
    const navGroups = tenant.role === 'SUPER_ADMIN' ? [
    ...
    ] : [
        {
            ...
            icon: List,
            items: [
                { id: 'demands', label: 'Central de Pedidos', icon: List, path: '/demands', roles: ['VEREADOR', 'ASSESSOR'] },
        ...
        },
        {
            ...
            icon: CheckCircle,
            items: [
                { id: 'votes', label: 'Painel de Votos', icon: CheckCircle, path: '/votes', roles: ['VEREADOR', 'ASSESSOR'] },
                { id: 'genealogy', label: 'Genealogia', icon: Users, path: '/genealogy', roles: ['VEREADOR', 'ASSESSOR'] },
            ]
        },
        {
            id: 'projetos',
            ...
            items: [
                ...
                { id: 'docs', label: 'Tramitação', icon: Briefcase, path: '/documents', roles: ['VEREADOR', 'ASSESSOR'] },
            ]
        },
        {
            id: 'comunicacao',
            ...
            items: [
                ...
                { id: 'calendar', label: 'Agenda de Ações', icon: Calendar, path: '/calendar', roles: ['VEREADOR', 'ASSESSOR'] },
        ...
        },
        {
            ...
            items: [
                { id: 'dashboard', label: 'Desempenho', icon: LayoutDashboard, path: '/', roles: ['VEREADOR', 'ASSESSOR'] },
