    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '2.5rem' }}>
                <button className="ai-prop-card">
                    <Search size={24} />
                    <span>Pesquisar Jurisprudência</span>
                </button>
                <button className="ai-prop-card">
                    <BookOpen size={24} />
                    <span>Sugerir PL Similar</span>
                </button>
                <button className="ai-prop-card">
                    <Scale size={24} />
                    <span>Viabilidade Jurídica</span>
                </button>
                <button className="ai-prop-card">
                    <Gavel size={24} />
                    <span>Redigir PL Completo</span>
                </button>
            </div>
            ...
            <div className="glass-card flex-col-mobile" style={{ marginBottom: '2.5rem', display: 'flex', gap: '1rem', alignItems: 'center' }}>
                ...
                <button className="btn-gold outline" style={{ borderRadius: '14px', width: 'fit-content' }}>
