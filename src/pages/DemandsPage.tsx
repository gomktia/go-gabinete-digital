    ...
    return (
        ...
        >
            <header className="responsive-header">
                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }} className="flex-col-mobile">
                    <button
                        className="btn-gold"
                        ...
                        <div style={{ borderTop: '1px solid var(--border)', paddingTop: '2rem' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                ...
                                <button
                                    ...
                                    style={{ padding: '12px', borderRadius: '12px', fontSize: '0.9rem', fontWeight: 700, background: 'linear-gradient(90deg, #1e3a8a 0%, #3b82f6 100%)', color: 'white' }}
                                >
                                    <Share2 size={18} /> Gerar Card Instantâneo (Antes/Depois)
                                </button>
                                <div style={{ gridColumn: 'span 2', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.75rem', marginTop: '0.5rem' }}>
                                    <button className="btn-gold outline" style={{ fontSize: '0.75rem', padding: '8px' }}>
                                        <Sparkles size={14} /> Sugerir Resposta Zap
                                    </button>
                                    <button className="btn-gold outline" style={{ fontSize: '0.75rem', padding: '8px' }}>
                                        <Share2 size={14} /> Encaminhar Secretaria
                                    </button>
                                    <button className="btn-gold outline" style={{ fontSize: '0.75rem', padding: '8px' }}>
                                        <List size={14} /> Resumo IA
                                    </button>
                                </div>
                            </div>
                        </div>
